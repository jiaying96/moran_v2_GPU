...
parser.add_argument('--train_nips', required=True, help='path to dataset') # train_nips reg_dataset/NIPS2014
parser.add_argument('--train_cvpr', required=True, help='path to dataset') # reg_dataset/CVPR2016
...
parser.add_argument('--adadelta', action='store_true', help='Whether to use adadelta (default is rmsprop)') # --adadelta
...
acc = 0
acc_tmp = 0
for epoch in range(opt.niter): #opt.niter   default=10
